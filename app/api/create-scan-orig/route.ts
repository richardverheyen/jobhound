...
export async function POST(req: NextRequest) {
  try {
    ...
    try {
      ...
      const systemPrompt = `
      You are an ATS analyzer focused on providing concise, actionable feedback. 
      Compare the resume file provided to the job posting and provide scores between 0-100 and brief insights for key areas. 
      Keep all analysis short and mobile-friendly - each section should be 2-3 sentences maximum. 
      Focus on the most important matches and gaps.
