  ...
  useEffect(() => {
    const signInAnonymously = async () => {
      try {
        ...
        setError(
          error.message ||
          "Failed to initialize session. Please refresh and try again."
        );
      } finally {
        setIsLoading(false);
      }
          ...
          <div className="flex">
            ...
            <div>
              <p className="text-sm text-blue-700 dark:text-blue-300">
                Enter your job details and upload your resume, then click "Scan
                Resume" to analyze your resume against the job description.
                You'll sign in with Google to save your data.
              </p>
            </div>
          </div>
        </div>
